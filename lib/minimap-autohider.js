...
function updateStyleVars({newValue}) {
  conf = atom.config.get("minimap-autohider")
  style = '// AUTOGENERATED\n'
  style += `@TransitionDuration: ${conf.TransitionDuration / 1000}s;\n`
  style += `@VisiblePercentage: ${conf.VisiblePercentage}%;\n`
